...
public final class GetPlayerBlacklistRspOuterClass {
  ...
  public interface GetPlayerBlacklistRspOrBuilder extends
    ...
    /**
     * <code>repeated .FriendBrief blacklist = 8;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < blacklist_.size(); i++) {
        output.writeMessage(8, blacklist_.get(i));
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < blacklist_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(8, blacklist_.get(i));
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "cklist\030\010 \003(\0132\014.FriendBrief\022\017\n\007retcode\030\013 " +
